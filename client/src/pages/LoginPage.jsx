...
const LoginPage = () => {
  ...
  return (
    ...
    <div className="flex flex-col w-[450px] mx-auto my-12 mt-[8em] bg-gray-100 rounded-xl shadow-md border border-gray-300 overflow-hidden font-sans">
        <a href="/"  className='w-full flex align-center mx-auto justify-center py-3 border-b' > 
         <svg width='60px' height='60px' viewBox="0 0 300 300" id="monkey3" version="1.1"  fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <circle cx="74" cy="82" r="32" 
